...
class UrusanModel extends Model
{
    ...
    protected $allowedFields = ['id', 'urusan', 'output_outcome', 'jenis_urusan', 'created_at', 'created_by', 'isactive'];
...
/* End of file UrusanModel.php */
/* Location: ./app/models/UrusanModel.php */
