...
class RumusModel extends Model
{
    ...
    protected $allowedFields = ['id', 'rumus', 'elemen_data', 'sumber_data', 'file_data_dukung', 'id_ikk', 'created_at', 'created_by', 'isactive'];
...
/* End of file RumusModel.php */
/* Location: ./app/models/RumusModel.php */
