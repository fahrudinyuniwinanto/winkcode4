...
class SyParsysModel extends Model
{
    ...
    protected $allowedFields = ['id','par_name','par_val','created_by','created_at','isactive','note']; 
...
/* End of file SyParsysModel.php */
/* Location: ./app/models/SyParsysModel.php */
