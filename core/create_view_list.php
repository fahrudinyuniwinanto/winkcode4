...
$string .= "<td>
            <span class=\"float-right\">
                <a type=\"button\" class=\"btn btn-sm btn-primary\" href=\"<?= base_url('$c_url/read/'.\$v['$pk'] )?>\">READ</a>
                <a type=\"button\" class=\"btn btn-sm btn-warning\" href=\"<?= base_url('$c_url/update/'.\$v['$pk'] )?>\">EDITE</a>
